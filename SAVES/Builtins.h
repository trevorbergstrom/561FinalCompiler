...
//obj_Int Int_method_MINUS (obj_Int, obj_Int);       /* Introduced */
//obj_Int Int_method_TIMES (obj_Int, obj_Int);       /* Introduced */
//obj_Int Int_method_DIVIDE (obj_Int, obj_Int);       /* Introduced */
//obj_Boolean Int_method_ATMOST (obj_Int, obj_Int);   /* Introduced */
//obj_Boolean Int_method_LESS (obj_Int, obj_Int);   /* Introduced */
//obj_Boolean Int_method_ATLEAST (obj_Int, obj_Int);   /* Introduced */
//obj_Boolean Int_method_GREATER (obj_Int, obj_Int);   /* Introduced */
